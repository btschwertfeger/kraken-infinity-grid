...
async def kraken_gridhodl_instance(
    ...
    engine._BotEngine__strategy._rest_api = (
        KrakenExchangeRESTServiceAdapter(
    ...
    api = KrakenAPI()
    engine._BotEngine__strategy._rest_api._KrakenExchangeRESTServiceAdapter__user_service = api
    engine._BotEngine__strategy._rest_api._KrakenExchangeRESTServiceAdapter__trade_service = api
    engine._BotEngine__strategy._rest_api._KrakenExchangeRESTServiceAdapter__market_service = api

    # ==========================================================================
    # The ws client can't be started here properly but is done by kraken sdk
    ...
    # ==========================================================================
    ## Misc
    engine._BotEngine__strategy._exchange_domain = engine._BotEngine__strategy._rest_api.get_exchange_domain()
