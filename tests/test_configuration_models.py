...
def test_bot_config_valid_strategy() -> None:
...
def test_bot_config_invalid_strategy() -> None:
...
def test_telegram_config_enabled_both_values() -> None:
...
def test_telegram_config_disabled_missing_token() -> None:
...
def test_telegram_config_disabled_missing_chat_id() -> None:
...
def test_telegram_config_disabled_both_missing() -> None:
...
def test_telegram_config_disabled_empty_values() -> None:
...
def test_bot_config_invalid_exchange() -> None:
...
def test_bot_config_invalid_userref() -> None:
...
def test_bot_config_invalid_max_investment() -> None:
...
def test_bot_config_invalid_interval() -> None:
...
def test_db_config_invalid_port() -> None:
...
def test_telegram_config_invalid_token() -> None:
