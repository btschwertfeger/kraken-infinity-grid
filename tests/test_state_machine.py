...
def test_facts_property_getter(state_machine: StateMachine) -> None:
...
def test_facts_property_setter_with_empty_dict(state_machine: StateMachine) -> None:
...
def test_transition_error_to_error_allowed(state_machine: StateMachine) -> None:
...
def test_all_valid_transitions_from_initializing(state_machine: StateMachine) -> None:
...
def test_all_valid_transitions_from_running() -> None:
...
def test_all_valid_transitions_from_error() -> None:
...
def test_no_valid_transitions_from_shutdown_requested() -> None:
...
def test_callback_exception_handling(state_machine: StateMachine) -> None:
...
def test_callback_execution_order(state_machine: StateMachine) -> None:
...
def test_state_property_immutability(state_machine: StateMachine) -> None:
...
def test_define_transitions_returns_correct_structure(
    ...
    assert set(transitions[States.RUNNING]) == {States.ERROR, States.SHUTDOWN_REQUESTED}
...
@pytest.mark.asyncio
async def test_wait_for_shutdown_when_already_in_shutdown_state() -> None:
...
@pytest.mark.asyncio
async def test_wait_for_shutdown_when_already_in_error_state() -> None:
...
@pytest.mark.asyncio
async def test_wait_for_shutdown_transition_to_shutdown_requested() -> None:
...
@pytest.mark.asyncio
async def test_wait_for_shutdown_transition_to_error() -> None:
...
@pytest.mark.asyncio
async def test_wait_for_shutdown_multiple_calls() -> None:
...
@pytest.mark.asyncio
async def test_wait_for_shutdown_event_creation() -> None:
